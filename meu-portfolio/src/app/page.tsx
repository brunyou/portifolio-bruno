...
<section className="h-screen bg-gradient-to-b from-black to-[#060010] flex items-center justify-center p-8">
  <div className="relative flex flex-col lg:flex-row w-[90%] lg:w-[85%] h-auto lg:h-[75%] rounded-[25px] border-2 border-[#530ECF] p-6 lg:p-12">
    ...
    <div
      className="
        ...
        lg:right-[40px]
        lg:w-[600px]
        drop-shadow-[0_20px_40px_rgba(83,14,207,0.35)]
      "
    >
      <CardSwap
        width={600}
      ...
      >
        ...
        <Card>
          ...
          <div className="p-4">
            ...
            <p className="text-zinc-400 text-sm mt-1">
              Design sóbrio e profissional para transmitir confiança.
            </p>
          </div>
        </Card>
        ...
        <Card>
          ...
          <div className="p-4">
            ...
            <p className="text-zinc-400 text-sm mt-1">
              Um lugar para exibir projetos e habilidades.
            </p>
          </div>
        </Card>
      </CardSwap>
